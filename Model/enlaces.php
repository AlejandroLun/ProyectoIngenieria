...
class Paginas{
	...
	public function enlacesPaginasModel($enlaces){
		...
		if(  $enlaces == "principalVentas"  || $enlaces=='buscar'){
		  ...
		  else if($enlaces == "mesa19"){

			$module =  "Views/modules/ventas/principalVentas.php";
		}
		  else if($enlaces == "mesa20"){

			$module =  "Views/modules/ventas/principalVentas.php";
		}
		  else if($enlaces == "mesa21"){

			$module =  "Views/modules/ventas/principalVentas.php";
		}
		  else if($enlaces == "mesa22"){

			$module =  "Views/modules/ventas/principalVentas.php";
		}
		  else if($enlaces == "mesa23"){

			$module =  "Views/modules/ventas/principalVentas.php";
		}
		  else if($enlaces == "mesa24"){

			$module =  "Views/modules/ventas/principalVentas.php";
		}
		  else if($enlaces == "mesa25"){
